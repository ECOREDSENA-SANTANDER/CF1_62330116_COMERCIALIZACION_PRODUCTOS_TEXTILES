  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 4
      h1 Producto textil y necesidades del mercado
    ...
    .bloque-texto-g.bg-color-acento-contenido.p-3.p-sm-4.p-md-5.mb-5
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require_src('@/assets/curso/temas/t4/2.png')})`}"
      )
      .bloque-texto-g__texto.p-4
        p.mb-0 Un producto textil tiene valor comercial cuando sus características técnicas pueden relacionarse con una necesidad real del cliente. La composición, el gramaje, la textura, la elasticidad, la resistencia, el acabado y el precio adquieren sentido cuando permiten resolver una expectativa de uso, producción o consumo. 
    
    .subt.mb-4(data-aos='fade-right')
      img(src='@/assets/curso/temas/t1/subt.svg', alt='')
      h3.mb-0.ms-3.me-5 Necesidades del mercado en relación con el sector textil
    ...
    #t_4_1.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 4.1 Reglamentos, organismos y laboratorios de referencia textil
    
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5.d-none.d-lg-block(data-aos='fade-left')
        img(src='@/assets/curso/temas/t4/9.png', alt='')
      .col-lg-7(data-aos='fade-right')
        p.mb-3 La selección comercial de un producto textil requiere revisar diferentes criterios que permiten determinar su pertinencia frente a una necesidad específica. Estos criterios facilitan la comparación entre materiales y orientan decisiones de compra, venta, producción o recomendación.

        p.mb-0 En este análisis, el producto textil no se valora de manera aislada, sino en relación con el uso final, el perfil del cliente, las propiedades técnicas, el precio, el rendimiento, la disponibilidad y el valor agregado. Estos aspectos permiten establecer si el material responde a una necesidad concreta del mercado y si puede presentarse con argumentos comerciales claros.
        ...
        AcordionA(tipo="b" clase-tarjeta="tarjeta bg-color-9")
          .row(titulo="Revisión del mercado")
            .col-md-11.mb-4.mb-md-0
              p Permite reconocer productos, colores, precios, materiales y estilos presentes en puntos de venta. Su uso en la comercialización textil ayuda a identificar la oferta actual y las oportunidades de diferenciación.
          .row(titulo="Revisión de competencia")
            .col-md-11.mb-4.mb-md-0
              p Permite reconocer características, precios, calidad y presentación de productos similares. Su uso apoya la comparación comercial y la definición de ventajas competitivas.
          .row(titulo="Consulta con clientes")
            .col-md-11.mb-4.mb-md-0
              p Permite identificar necesidades, expectativas, dificultades y preferencias de compra. Su uso orienta la selección de textiles y la argumentación de venta.
          .row(titulo="Análisis de tendencias")
            .col-md-11.mb-4.mb-md-0
              p Permite reconocer cambios en color, textura, acabados, usos y comportamientos de consumo. Su uso favorece la actualización del portafolio y la planeación de productos.
          .row(titulo="Lista de chequeo del producto")
            .col-md-11.mb-4.mb-md-0
              p Permite verificar composición, calidad, precio, acabado, uso y disponibilidad. Su uso organiza la evaluación del textil antes de su compra, venta o recomendación. 
      .col-lg-4.d-none.d-lg-block(data-aos='fade-left')
        img(src='@/assets/curso/temas/t4/17.png', alt='')
    
    separador
    #t_4_2.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 4.2 Tendencias, valor agregado y decisión de compra
    
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-5.d-none.d-lg-block(data-aos='fade-right')
        img(src='@/assets/curso/temas/t4/18.png', alt='')
      .col-lg-7(data-aos='fade-left')
        p.mb-4 Las tendencias de moda influyen en la selección, producción y comercialización de productos textiles porque orientan cambios en colores, texturas, estampados, siluetas, acabados, materiales y formas de consumo. 
        p.mb-4 Aunque una tendencia no determina por completo la calidad de una tela, sí puede incidir en su aceptación dentro del mercado y en la manera como las marcas, diseñadores o compradores la incorporan en sus productos.
        .cajon.color-secundario.bg-color-2.p-4
          p.mb-0 En el sector textil, las tendencias permiten anticipar demandas del consumidor y reconocer transformaciones en los gustos, estilos de vida, hábitos de compra y preferencias estéticas. Un color de alta circulación, una textura asociada a una temporada, un acabado funcional o una base textil vinculada con comodidad puede convertirse en un factor relevante para la decisión comercial.
    
    p.mb-5 La lectura de tendencias también aporta información para planear colecciones, seleccionar insumos, organizar portafolios y definir argumentos de venta. Cuando un producto textil responde a una tendencia, su presentación comercial puede relacionarse con actualidad, diferenciación y oportunidad de mercado. Sin embargo, su incorporación requiere equilibrio entre novedad, funcionalidad, costo, calidad y permanencia del producto.
      ...
      .col-lg-8
        SlyderF.fw(columnas="col-lg-6 col-xl-4")
          .tarjeta.bg-color-2.p-4
            ...
            h5.text-center Cambios en paletas de color
            p.mb-0 Aumentan la demanda de determinadas gamas cromáticas. Se aplican en la selección de telas por temporada, colección o línea de producto.
          .tarjeta.bg-color-2.p-4
            .row.justify-content-center.mb-3
              .col-7.col-md-4.col-lg-8
                img(src='@/assets/curso/temas/t4/21.svg' alt='')
            h5.text-center Preferencia por comodidad
            p.mb-0 Favorece textiles suaves, flexibles, livianos o de fácil cuidado. Se aplica en prendas casuales, deportivas, interiores o de uso cotidiano.
          .tarjeta.bg-color-2.p-4
            .row.justify-content-center.mb-3
              .col-7.col-md-4.col-lg-8
                img(src='@/assets/curso/temas/t4/22.svg' alt='')
            h5.text-center Interés por funcionalidad
            p.mb-0 Impulsa materiales con desempeño específico. Se aplica en textiles repelentes, elásticos, transpirables, resistentes o de secado rápido.
          .tarjeta.bg-color-2.p-4
            .row.justify-content-center.mb-3
              .col-7.col-md-4.col-lg-8
                img(src='@/assets/curso/temas/t4/23.svg' alt='')
            h5.text-center Búsqueda de diferenciación estética
            p.mb-0 Incrementa el uso de estampados, texturas, brillos o superficies intervenidas. Se aplica en moda comercial, productos de autor, decoración o cápsulas de temporada.
          .tarjeta.bg-color-2.p-4
            .row.justify-content-center.mb-3
              .col-7.col-md-4.col-lg-8
                img(src='@/assets/curso/temas/t4/24.svg' alt='')
            h5.text-center PConsumo responsable
            p.mb-0 Promueve materiales durables, reciclados, trazables o de menor impacto. Se aplica en portafolios con enfoque sostenible, productos de larga vida útil o comunicación de valor agregado.
          .tarjeta.bg-color-2.p-4
            .row.justify-content-center.mb-3
              .col-7.col-md-4.col-lg-8
                img(src='@/assets/curso/temas/t4/25.svg' alt='')
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-lg-7(data-aos='fade-left')
        p.mb-4 El valor agregado de un producto textil se construye cuando sus características ofrecen beneficios diferenciados para el cliente o para el producto final. Este valor puede originarse en la composición de la fibra, la calidad del hilo, la estructura del tejido, el acabado aplicado, la presentación comercial, el desempeño funcional o la relación con tendencias de moda.
        p.mb-0 En un proceso de comercialización, el valor agregado permite explicar por qué un textil puede tener mayor precio, mejor desempeño o mayor aceptación que otro. Un material con buena solidez del color, tacto suave, fácil mantenimiento y acabado funcional puede resultar más atractivo para un comprador que requiere reducir reclamos, mejorar la experiencia de uso o diferenciar su oferta.
    ...
    .bg-color-3.mb-4
      img(src='@/assets/curso/temas/t4/33.svg', alt='')
      .bg-color-primario.p-4
        .tarjeta.bg-white.p-4
          TarjetaAudio.color-secundario(
          texto="<b>Consulte el pódcast:</b> Producto textil, mercado y decisión de compra "
          :audio="require_src('@/assets/actividad/audio/success.mp3')")
          .indicador--click(v-if="mostrarIndicadorTarjetaAudio")
    
    p El producto textil adquiere pertinencia cuando responde a una necesidad concreta y puede sostenerse mediante información técnica, valor comercial y correspondencia con el mercado. Esta relación permite seleccionar materiales de forma más estratégica, presentar beneficios con claridad y fortalecer la competitividad de la oferta textil.
